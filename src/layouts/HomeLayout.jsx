...
const LayoutHome = () => {
    return (
        <div className="h-screen">
            ...
            <footer className="p-4 bg-white sm:p-6 dark:bg-gray-900 color-reputationApp">
        ...
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 Flowbite™. All Rights Reserved.
        </span>
